...
RETURNING id, username, refresh_token, user_agent, client_ip, is_blocked, expires_at, created_at, updated_at, deleted_at
`
...
SELECT id, username, refresh_token, user_agent, client_ip, is_blocked, expires_at, created_at, updated_at, deleted_at FROM sessions
WHERE id = $1 LIMIT 1
`
